                ...
                <div className="space-y-8" data-aos="fade-up">
                    ...
                    <div className="space-y-6 text-base leading-relaxed text-gray-700">
                        <div>
                            ...
                            <p>
                                「具体と抽象」が基礎体力、「バイアス」が技。<br />
                                無意識の偏りを意図的に操ることで、ひらめきを生む。
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                問題を分解し、複雑な構造の中からクリティカルな一手を発見。<br />
                                それが全体最適を導く。
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                提案に「情熱・論理・信頼」を宿らせ、共感と納得を生み出す。<br />
                                感情とロジックの統合が、人を動かす力になる。
                            </p>
                        </div>
                    </div>
                </div>
